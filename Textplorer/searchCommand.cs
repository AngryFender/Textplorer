...
namespace Textplorer
{
    ...
    internal sealed class searchCommand
    {
        ...
        /// </summary>
        public static readonly Guid CommandSet = new Guid("4d660e0f-2103-4882-af67-017cabd287b7");
        ...
        private void Execute(object sender, EventArgs e)
        {
            ...
            {
                ToolWindowPane window = await this.package.ShowToolWindowAsync(typeof(search), 0, true, this.package.DisposalToken);
